//***************************************************************************************/
// 
// File name: LMI_Gocator2300_M10PP3.cpp  
//
...
void PrintHeader()   
   ...
   MosPrintf(MIL_TEXT("[EXAMPLE NAME]\n")
             MIL_TEXT("LMI_Gocator2300_M10PP3\n\n")
...
int MosMain()
   ...
   MosPrintf(MIL_TEXT("  Pages of the LMI_Gocator2300_M10PP3 project. Then, under Configuration Properties,\n"));
   ...
   MosPrintf(MIL_TEXT("  Property Pages of the LMI_Gocator2300_M10PP3 project. Then, under Configuration\n"));
...
void AcquirePointCloudData(SObjects* ObjectsPtr)
   ...
   GoSetup_SetScanMode(CamSetup, GO_MODE_SURFACE)                                 , MIL_TEXT("GoSetup_SetScanMode")              ; // Set the scan mode to acquire surface data
            ...
            for(MIL_INT iRow = 0; iRow < NumPositionRows; iRow++)
               ...
               for(MIL_INT iCol = 0; iCol < NumPositionCols; iCol++)
                  ...
                  if (DataRowPtr[iCol] != INVALID_RANGE_16BIT)
                     ...
                     PointCloud.x[iPoint] = XOffset + XResolution * iCol -2000;
